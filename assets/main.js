...
class TrackList {
  ...
  template(music) {
    ...
    return music
      .map(track => {
        // !!! -> figure out later how to make "Album only" show up, you tried and didn't work
        ...
        <div class="row rowEffect">
          <div class="coverimgcontainer"><img class="coverimg" src="${
  track.artworkUrl100
}"</img></div>
  ...
  render() {
    ...
    output +=
      this.viewData &&
      (Array.isArray(this.viewData) && this.viewData.length > 0)
        ? `<p><i class="fab fa-itunes-note"></i> Your search has ${
